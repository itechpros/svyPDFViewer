...
function webViewerLoad() {
  ...
  try{pdfjsWebApp.PDFViewerApplication.run(config);}catch(e){console.log('Failed to load viewer')} 
}
...
function renderPage(activeServiceOnEntry, pdfDocument, pageNumber, size) {
	...
	dpi && _app_options.AppOptions.set('printResolution', Number(dpi.options[dpi.selectedIndex].value) || 300)
